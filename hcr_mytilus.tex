...
\begin{table}[H]
	...
	\begin{tabular}{r
		...
		SDS               & 10                                    & \unit{\ml}                                                                                             & 238.38	                                                                                                        & \qty{1.0}{\percent}		\\
		Tween 20	      & 500                                   & \unit{\ul}                                                                                             & 1227.54                                                                                                        & \qty{0.5}{\percent}		\\
		Tris \ce{HCl} pH 7.5	& 5                               & \unit{\ml}                                                                                             & \NA                                                                                                        	& \qty{50}{\milli\molar}	\\
		EDTA			  & 0.2	                                  & \unit{\ml}                                                                                             & 292.2438                                                                                                       & \qty{1.0}{\milli\molar}	\\
		\qty{5}{\molar} \ce{NaCl}	& 3.0                         & \unit{\ml}                                                                                             & 58.44	                                                                                                        & \qty{150.0}{\milli\molar}	\\
		Ultrapure water   & \multicolumn{2}{c}{\NA}               & \NA                                                                                                    & \NA
	\end{tabular}
\end{table}

\begin{enumerate}
	\item Combine everything in a beaker.
	\item Fill up to \qty{100}{\ml} with ultrapure water, stir and heat up to \qty{40}{\degreeCelsius} until clear.
\end{enumerate}
