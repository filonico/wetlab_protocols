...
{\small \emph{First created}: \DTMdisplaydate{2025}{02}{11}{-1}\hfill%
...
\alert{For fixation and the following steps, samples can be placed in Eppendorf tubes or in wells of a spot plate.}
...
\begin{enumerate}[resume = steps]
	\item \step{rinse}{3 times}{\fivehunmicrol}{PBST}{RT (no incubation)}
