...
\begin{table}[H]
	...
	\begin{tabular}{r
		...
		\ce{NaCl}								 & 2.922								 & \unit{\g}																							  & 58.44																										    & \qty{0.5}{\molar}        \\
		\ce{MgSO4 * 7H2O}					     & 0.0493								 & \unit{\g}																							  & 246.5																										    & \qty{2}{\milli\molar}    \\
...
\begin{enumerate}
	...
	\item Add \qty{2.093}{\g} of MOPS buffer, \qty{2.922}{\g} of \ce{NaCl}, and \qty{0.0493}{\g} of \ce{MgSO4*7H2O} to a becker.
	...
	\item Add \qty{1}{\molar} \ce{NaOH} dropwise, to increase the pH of the solution and aid parafolmadehyde full solubilization.
	\item Keep stirring until the solution clears.
	\item Fill up to \qty{100}{\ml} with ultrapure water, using a graduated cylinder.
	\item Adjust the pH to 7.0 by adding dropwise \qty{1}{\molar} \ce{HCl}.
...
\begin{enumerate}
	\item \textbf{mRNA fluorescent \textit{in-situ} HCR in \textit{Sycon} spp.}
		\begin{itemize}
			...
			\item Voigt, O., Wilde, M. V., Fröhlich, T., Fradusco, B., Vargas, S., \& W{\"o}rheide, G. (2025). Genetic parallels in biomineralization of the calcareous sponge \textit{Sycon ciliatum} and stony corals. \textit{bioRxiv}. \ulhref{https://doi.org/10.1101/2025.02.06.636789}{10.1101/2025.02.06.636789}
		\end{itemize}
