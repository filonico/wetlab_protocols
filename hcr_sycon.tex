...
\begin{table}[H]
	...
	\begin{tabular}{r
		...
		Ultrapure water                          & \NA                                   & \unit{\ml}                                                                                             & \NA                                                                                                             & \NA
	\end{tabular}
\end{table}
...
\subsection*{0.25\per{} Holtfreter\curlyapostrophe s solution (HS)}
...
\begin{table}[H]
	...
	\begin{tabular}{r
		...
		\ce{NaCl}         & 875                                   & \unit{\mg}                                                                                             & 58.44                                                                                                        & \qty{0.01}{\molar}    \\
		\ce{KCl}          & 12.5                                  & \unit{\mg}                                                                                             & 74.55                                                                                                        & \qty{0.00002}{\molar} \\
		\ce{CaCl2}        & 25                                    & \unit{\mg}                                                                                             & 110.98                                                                                                       & \qty{0.0002}{\molar}  \\
		\ce{NaHCO3}       & 50                                    & \unit{\mg}                                                                                             & 84                                                                                                           & \qty{0.00006}{\molar} \\
