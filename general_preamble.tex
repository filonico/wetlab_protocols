% DOCUMENT STYLE
\usepackage[a4paper,left=1.5cm, right=1.5cm, top=2.7cm, bottom=2cm,headsep=\dimexpr2.5cm-55pt\relax,headheight=55pt]{geometry}
...
\DeclareSIUnit{\activeunit}{U}                    % define unit for enzyme active units
\DeclareSIUnit{\hpf}{hpf}                         % define unit for hours post fertilization    
\DeclareSIUnit{\embryo}{embryos}                  % define unit for embryos                     
\DeclareSIUnit{\cells}{cells}                     % define unit for cells                         
\DeclareSIUnit{\rpm}{rpm}                         % define unit revolutions per minute
